      ...
      <div className="space-y-4">
        <div className="mb-4 flex items-center justify-between gap-2">
          ...
          <Button
            variant="ghost"
            size="sm"
            onClick={() => setShowPropertyOverview(!showPropertyOverview)}
          >
            {showPropertyOverview ? "Hide" : "Show"} Property Overview
          </Button>
        </div>
            ...
            <div className="mt-6 border-t pt-4">
              ...
              {categoryLoading ? (
                ...
                <div className="py-4 text-center text-sm text-gray-500">
                  No category data available. Sync reviews to see category
                  averages.
                </div>
              )}
            </div>
